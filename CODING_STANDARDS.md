<!-- Generated by scripts/install-standards.sh from claude-conf standards/: bash.md coding.md go.md security.md
     Regenerate: ./scripts/install-standards.sh bash coding go security -->
